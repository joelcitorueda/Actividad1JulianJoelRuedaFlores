namespace SistemaComputador.VISTA.ComputadoraVista
{
	partial class ComputadoraListarVista
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Size = new Size(685, 333);
			dataGridView1.TabIndex = 0;
			// 
			// button4
			// 
			button4.Location = new Point(383, 375);
			...
			// button3
			// 
			button3.Location = new Point(201, 375);
			...
			// button2
			// 
			button2.Location = new Point(32, 375);
			...
			button1.Location = new Point(577, 375);
